...
#
# caffe.INFOからグラフを得る
# $CAFFE_ROOT/tools/extra/plot_training_log.py.exampleを改変
# 変更場所は以下の2か所
#  ・get_log_parsing_script()内のファイルパスの指定方法を変更
#    (caffe直下のディレクトリではなく，作業ディレクトリで操作できるようにするため)
#  ・get_log_file_suffix()内で接尾語が".log"に限定してされていた箇所を限定しないように変更
#    (caffe.INFOを直接扱えるようにするため)
...
def get_log_parsing_script():
    ...
    return dirname + '/caffe/tools/extra/parse_log.sh'  
